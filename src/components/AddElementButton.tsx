...
export default function AddElementButton({
  ...
  return (
    <button
      ...
      className="flex flex-col transition duration-300 ease-in-out hover:bg-purple-50 w-[calc(50%-5px)] items-center justify-center gap-2 p-4 rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"
    >
      {button.icon}
